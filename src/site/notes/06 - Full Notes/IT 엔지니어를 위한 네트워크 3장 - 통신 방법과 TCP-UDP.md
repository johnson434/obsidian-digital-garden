---
{"dg-publish":true,"permalink":"/06-full-notes/it-3-tcp-udp/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- **애니캐스트**: 1대1 통신이지만 그룹 중에서 가장 가까운 노드와 1대1 통신을 합니다. 가장 가까운 DNS 서버를 찾거나 가장 가까운 게이트웨이를 찾는 애니캐스트 게이트웨이 기능에 사용하기도 합니다.
